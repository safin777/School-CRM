        ...
        public function editStudentDetails(Request $request ,$sid)
        {
            ...
            public function addSubjectPost(Request $request)
            {
                ...
                [
                    ...
                    'subject_name.required' => 'subject name can not be blank.',
                    'subject_code.required' => 'Subject Code field  can not be blank.',
                ...
                if($validatedData->fails())
                {
                        return view('admin.addSubject')->withErrors($validatedData);
                }
                ...
                else
                {
                    ...
                    $notice="Subject added successfully";

                    DB::table('subject_list')->insert($data);
                    return view('admin.addSubject')->withErrors($notice);
