      ...
      {{-- PROFILE VIEW WIDGET --}}
        ...
        <div class="row">
            <div class="card-body text-sm">
                <form action="{{ URL::to('teacher/upload/result')}}"  method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mx-auto">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control" name="marks" value="" placeholder="Enter Marks" id="">
                            </div>
                        </div>
