                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="{{URL::to('teacher/assignment/delete/'.base64_encode($a->d_assign_id))}}" onclick="return confirm('Are you sure to delete this row?')" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i>Delete</a>
                                 </td>
                            </tr>
                            @endforeach
                        </tbody>
